...
import jloda.fx.control.ASingleSelectionModel;
 ...
 * Daniel Huson, 4.2019
 * from jloda2, only changed access of moveTab() to public
 */
public class SplittableTabPane extends Pane {
    ...
    public void moveTab(Tab tab, TabPane oldTabPane, TabPane newTabPane) {
