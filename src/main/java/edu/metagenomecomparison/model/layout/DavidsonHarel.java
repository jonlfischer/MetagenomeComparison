package edu.metagenomecomparison.model.layout;
...
public class DavidsonHarel {
    ...
    public void layoutWithDH(double coolingFactor,
        ...
        double WEIGHT_NODE_DIST = 13; //1.0F;
        double WEIGHT_BORDER = 0;
...
*/
            ...
            for (int p = 0; p < noNodes; p++) {
                ...
                for (int t = 0; t < noTries; t++) {
                    ...
                    if (WEIGHT_NODE_EDGE_DIST != 0 && isFineTuning) {
                        ...
                        Iterable<Edge> incident = nodes[v].inEdges();
    ...
    //TODO determine if this is the way or reimplement java code, wrap in process
